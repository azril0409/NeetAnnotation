...
public class AndroidClass {
    ...
    public static final ClassName FragmentActivity = ClassName.get("android.support.v4.app", "FragmentActivity");
    ...
    public static final ClassName Toolbar_v7 = ClassName.get("android.support.v7.widget", "Toolbar");
    public static final ClassName RequiresApi = ClassName.get("android.support.annotation", "RequiresApi");
